...
from vimms_gym.common import EVAL_F1_INTENSITY_THRESHOLD, METHOD_DQN, METHOD_PPO
...
method = METHOD_PPO
HISTORY_HORIZON = 1
model = MaskablePPO.load(os.path.join('notebooks', 'QCB_resimulated_medium', 'PPO_2.0E5',
                     'DDAEnv_PPO_alpha_0.00_beta_0.00_horizon_%d.zip' % HISTORY_HORIZON))
out_dir = 'profile'
