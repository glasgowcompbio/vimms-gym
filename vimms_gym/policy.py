...
def topN_policy(obs, N):
    ...
    fragmented_above = count_df.loc['fragmented_above'].values[0]
    fragmented_below = count_df.loc['fragmented_below'].values[0]
    if fragmented_above + fragmented_below >= N:
