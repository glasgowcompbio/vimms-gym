...
OBS_EXCLUDED = 2
OBS_ROI_LENGTH = 3
OBS_ROI_ELAPSED_TIME_SINCE_LAST_FRAG = 4
OBS_ROI_INTENSITY_AT_LAST_FRAG = 5
OBS_ROI_MIN_INTENSITY_SINCE_LAST_FRAG = 6
OBS_ROI_MAX_INTENSITY_SINCE_LAST_FRAG = 7
OBS_ROI_INTENSITIES_2 = 8
OBS_ROI_INTENSITIES_3 = 9
OBS_ROI_INTENSITIES_4 = 10
OBS_ROI_INTENSITIES_5 = 11
TOTAL_OBSERVATION = 12
